...
var level2 = document.querySelector('.grille2');
...
document.onkeydown = function (event) {
    ...
    if (level2.querySelector('#a38').querySelector(".ball") && document.querySelector('#a48').querySelector(".ball") && document.querySelector('#a58').querySelector(".ball")){
