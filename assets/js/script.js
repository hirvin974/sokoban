...
var level1 = document.querySelector('.grille');
...
document.onkeydown = function (event) {
    ...
    if (level1.querySelector('#a14').querySelector(".ball") && document.querySelector('#a37').querySelector(".ball") && document.querySelector('#a42').querySelector(".ball")){
