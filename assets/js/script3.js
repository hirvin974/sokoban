...
var level3 = document.querySelector('.grille3');
...
document.onkeydown = function (event) {
    ...
    if (level3.querySelector('#a22').querySelector(".ball") && document.querySelector('#a55').querySelector(".ball") && document.querySelector('#a67').querySelector(".ball")){
